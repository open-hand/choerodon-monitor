...
databaseChangeLog(logicalFilePath: 'script/script/hmnt_audit_data_config_line.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-08-17-hmnt_audit_data_config_line") {
        ...
        createTable(tableName: "hmnt_audit_data_config_line", remarks: "数据审计配置行") {
            column(name: "audit_data_config_line_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "entity_column_id", type: "bigint(20)",  remarks: "实体列ID，HPFM_ENTITY_COLUMN.ENTITY_COLUMN_ID")  {constraints(nullable:"false")}  
            ...
            column(name: "audit_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "是否审计")  {constraints(nullable:"false")}  
