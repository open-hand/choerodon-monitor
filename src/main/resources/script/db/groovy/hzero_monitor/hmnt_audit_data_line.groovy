...
databaseChangeLog(logicalFilePath: 'script/script/hmnt_audit_data_line.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-08-17-hmnt_audit_data_line") {
        ...
        createTable(tableName: "hmnt_audit_data_line", remarks: "数据审计行") {
            column(name: "audit_data_line_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "audit_data_id", type: "bigint(20)",  remarks: "数据审计ID")  {constraints(nullable:"false")}  
            column(name: "audit_data_config_line_id", type: "bigint(20)",  remarks: "数据审计配置行ID")  {constraints(nullable:"false")}  
