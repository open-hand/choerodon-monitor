...
databaseChangeLog(logicalFilePath: 'script/script/hmnt_audit_op_config.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-07-24-hmnt_audit_op_config") {
        ...
        createTable(tableName: "hmnt_audit_op_config", remarks: "操作审计配置") {
            column(name: "audit_op_config_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "permission_id", type: "bigint(20)",  remarks: "接口权限ID,iam_permmission.id")  {constraints(nullable:"false")}  
            column(name: "audit_args_flag", type: "tinyint(1)",  remarks: "是否审计请求参数信息")  {constraints(nullable:"false")}  
            column(name: "audit_result_flag", type: "tinyint(1)",  remarks: "是否审计请求响应信息")  {constraints(nullable:"false")}
    ...
    changeSet(author: 'hzero@hand-china.com', id: '2020-01-04-hmnt_audit_op_config') {
        addColumn(tableName: 'hmnt_audit_op_config') {
            column(name: 'audit_data_flag', type: "tinyint(1)", remarks: '是否审计操作数据') {
