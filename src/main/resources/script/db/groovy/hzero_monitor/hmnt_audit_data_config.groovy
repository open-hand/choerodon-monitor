...
databaseChangeLog(logicalFilePath: 'script/script/hmnt_audit_data_config.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-08-17-hmnt_audit_data_config") {
        ...
        createTable(tableName: "hmnt_audit_data_config", remarks: "数据审计配置") {
            column(name: "audit_data_config_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID,hpfm_tenant.tenant_id")  {constraints(nullable:"false")}  
            column(name: "entity_table_id", type: "bigint(20)",  remarks: "实体表ID，HPFM_ENTITY_TABLE.ENTITY_TABLE_ID")   
