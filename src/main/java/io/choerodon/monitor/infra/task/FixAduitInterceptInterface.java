...
public class FixAduitInterceptInterface {
    ...
    static {
        ...
        stringLongHashMap.put("choerodon-iam.choerodon-tenant.enableOrganization", "'  [' + #_userDetails.getRealName() + '] 启用了组织'");
        stringLongHashMap.put("choerodon-iam.choerodon_register_info_pro.approval", "'  [' + #_userDetails.getRealName() + '] 审批了组织'");
        stringLongHashMap.put("choerodon-iam.choerodon-tenant.disableOrganization", "'  [' + #_userDetails.getRealName() + '] 停用了组织'");
        stringLongHashMap.put("choerodon-iam.choerodon-user.addDefaultUsers", "'  [' + #_userDetails.getRealName() + '] 分配了root用户'");
        stringLongHashMap.put("choerodon-iam.hiam-user.frozenUser", "'  [' + #_userDetails.getRealName() + '] 停用用户'");
        stringLongHashMap.put("choerodon-iam.hiam-user-site-level.frozenUser", "'  [' + #_userDetails.getRealName() + '] 停用用户'");
        stringLongHashMap.put("choerodon-iam.organization-user.disableUser", "'  [' + #_userDetails.getRealName() + '] 停用用户'");
    }
